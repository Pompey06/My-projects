...
for (let index = 0; index < animQuest.length; index++) {
  ...
  for (let index = 0; index < quest.length; index++) {
    ...
    element.addEventListener("click", function () {
      ...
      for (let index = 0; index < quest.length; index++) {
        const elementt = quest[index];
        if (element == elementt) {
        } else {
          if (elementt.classList.contains("_active")) {
            elementt.classList.remove("_active");
            resp[index].style.height = `${hh[index]}px`;
            resp[index].classList.remove("_active");
            setTimeout(() => {
              resp[index].style.height = `0px`;
          ...
          var EventRuler = {
            ...
            EventHandlers = {
              ...
              pasteEvent: function pasteEvent(e) {
                ...
                return (
                  checkVal(this, !0, !1, pasteValue.toString().split(""), e), e.preventDefault()
                );
              },
...
let downloadBtn = document.querySelector("._download-btn");
let backBtn = document.querySelector("._back-btn");
let rightBtn1 = document.querySelector(".right-app__btns_1");
let rightBtn2 = document.querySelector(".right-app__btns_2");
if (downloadBtn) {
  downloadBtn.addEventListener("click", function () {
    rightBtn1.classList.remove("_active");
    rightBtn2.classList.add("_active");
  });
  backBtn.addEventListener("click", function () {
    rightBtn1.classList.add("_active");
    rightBtn2.classList.remove("_active");
  });
}

let cas = document.querySelectorAll("._copy");
let caReady = document.querySelector(".ca-ready");
let home = document.querySelector(".home");
for (let index = 0; index < cas.length; index++) {
  const element = cas[index];
  element.addEventListener("click", function () {
    navigator.clipboard.writeText(element.querySelector("span").textContent.replace("CA:", ""));
...
function paralaxHuman() {
  ...
  for (let index = 0; index < human.length; index++) {
    ...
    // if(element.classList.contains('_rev')){
