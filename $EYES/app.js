...
document.getElementById("photoInput").addEventListener("change", function (event) {
   ...
   if (file) {
      ...
      document.getElementById("makeQuePro").click();
   }
});
...
document.getElementById("makeQuePro").addEventListener("click", function () {
   ...
   if (uploadedImg.src.includes("./image/background-desktop-1YBVvAA1.jpg")) {
      document.getElementById("photoInput").click();
      return;
   }
   ...
   faceImg.style.width = `${faceImgSize * 1.5}px`;
   ...
   faceImg.style.top = `${(uploadedImgHeight - faceImgSize) / 12}px`;
