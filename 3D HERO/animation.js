   ...
   if (animItems.length > 0) {
      ...
      function animOnScroll() {
         for (let index = 0; index < animItems.length; index++) {
            ...
            // Для элементов платформы
            if (animItem.classList.contains("platform_anim") || animItem.classList.contains("platform_anim_2")) {
               // Определяем значение в зависимости от ширины экрана
               const scrollTrigger = window.innerWidth < 500 ? 150 : 300;
               if (pageYOffset > scrollTrigger) {
